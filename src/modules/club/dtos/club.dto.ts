...
export class ListMyClubsQueryDto {
  @ApiPropertyOptional({ description: '페이지네이션 커서(base64url)' })
  @IsOptional()
  @IsString()
  cursor?: string;
...
export class MyClubListItemDto {
  ...
  @ApiProperty({
    description: '클럽 썸네일 URL',
    example: 'https://cdn.example.com/clubs/12.jpg',
    nullable: true,
  })
  thumbnailUrl: string | null;
...
export class ListMyClubsResponseDto {
  @ApiProperty({ type: [MyClubListItemDto] })
  clubs: MyClubListItemDto[];

  @ApiProperty({
    description: '다음 페이지 커서',
    example:
      'eyJqb2luZWRBdCI6IjIwMjYtMDQtMTBUMDk6MDA6MDAuMDAwWiIsImNsdWJVc2VySWQiOiIxIn0',
    nullable: true,
  })
  nextCursor: string | null;
}
